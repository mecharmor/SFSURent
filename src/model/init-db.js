...
const InsertTestListings = async () => {
  ...
  + 'price = 1000.99, '
  + 'title = "Near to SFSU, student friendly", '
  + 'description = "description one", '
  + 'address = "3711 19th Ave San Francisco, CA", '
  + 'thumb = ?, '
  + 'zipcode = 94132, '
  + 'num_bed = 2, '
  + 'num_bath = 2, '
  ...
  await db.query('INSERT INTO listings SET '
  + 'price = 1999.99, '
  + 'title = "Need a place near SFSU, here you go!", '
  + 'description = "bungalow description", '
  + 'address = "45 Lansing St San Francisco, CA", '
  + 'thumb = ?, '
  + 'zipcode = 94105, '
  + 'num_bed = 3, '
  + 'num_bath = 3, '
  ...
  await db.query('INSERT INTO listings SET '
  + 'price = 1600.00, '
  + 'title = "Looking new roomates for apartment, SFSU", '
  ...
  await db.query('INSERT INTO listings SET '
  + 'price = 1700.00, '
  + 'title = "Accomodation for one room near SFSU", '
  + 'description = "description four", '
  + 'address = "2616 Ocean Ave San Francisco, CA", '
  + 'thumb = ?, '
  + 'zipcode = 94132, '
  + 'num_bed = 2, '
  + 'num_bath = 2, '
  ...
  await db.query('INSERT INTO listings SET '
  + 'price = 2000.00, '
  + 'title = "Quite place for students, SFSU , SJSU", '
  + 'description = "description five", '
  + 'address = "787 The Alameda San Jose, CA", '
  + 'thumb = ?, '
  + 'zipcode = 95126, '
  + 'num_bed = 2, '
  + 'num_bath = 2, '
  ...
  await db.query('INSERT INTO listings SET '
  + 'price = 1200.00, '
  + 'title = "Imagine coming home to this gorgeous 1 bedroom apartment", '
  ...
  await db.query('INSERT INTO listings SET '
  + 'price = 1700.00, '
  + 'title = "SAN FRANCISCO HOME FOR RENT", '
  + 'description = "description seven", '
  + 'address = "482 38th St Oakland, CA", '
  + 'thumb = ?, '
  + 'zipcode = 94609, '
  + 'num_bed = 2, '
  + 'num_bath = 2, '
